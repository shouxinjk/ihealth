		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="examfrequency/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="EXAMFREQUENCY_ID" id="EXAMFREQUENCY_ID" value="${pd.EXAMFREQUENCY_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">CRON表达式，定义检查的间隔频率:</td>
