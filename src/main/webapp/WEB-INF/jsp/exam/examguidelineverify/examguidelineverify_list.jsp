			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="examguideline/listVerify.do" method="post" name="Form" id="Form">
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1&&var.STATUS eq '已提交'}">
														<a class="btn btn-xs btn-success" title="审核" onclick="auditing1('${var.EXAMGUIDELINE_ID}','已审核')">
		...
		function auditing1(Id,STATUS){
			bootbox.confirm("确定要操作吗?", function(result) {
				if(result) {
					...
					$.get(url,function(data){
						location.href="<%=basePath%>examguideline/listVerify.do?dnowPage=${page.currentPage}";
					});
				}
			});
		}
