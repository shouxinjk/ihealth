							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<c:if test="${var.STATUS == '已提交' or var.STATUS == '已审核'}">
										<tr>
											<td class='center'>
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<c:if test="${QX.edit == 1}">
															<li>
																<a style="cursor:pointer;" onclick="auditSuccess('${var.ARTICLE_ID}');" class="tooltip-success" data-rel="tooltip" title="审核通过">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="auditError('${var.ARTICLE_ID}');" class="tooltip-error" data-rel="tooltip" title="审核拒绝">
																	<span class="red">
