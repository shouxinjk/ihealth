...
<body class="no-skin">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="查看" onclick="find('${var.ORDER_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<li>
																<a style="cursor:pointer;" onclick="find('${var.ORDER_ID}');" class="tooltip-success" data-rel="tooltip" title="查看">
																	<span class="green">
	...
	<script type="text/javascript">
		...
		function find(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="查看";
			 diag.URL = '<%=basePath%>order/goFind.do?ORDER_ID='+Id;
			 diag.Width = 800;
			 diag.Height = 600;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
