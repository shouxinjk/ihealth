...
public class MedicalExamItemController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).get("PRICE2").toString());	//3
			vpd.put("var4", varOList.get(i).getString("TIPS"));	//4
			vpd.put("var5", varOList.get(i).getString("STATUS"));	//5
			vpd.put("var6", varOList.get(i).get("CREATEBY").toString());	//6
