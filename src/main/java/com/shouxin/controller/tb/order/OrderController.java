package com.shouxin.controller.tb.order;
...
import com.shouxin.service.tb.order.OrderManager;
...
public class OrderController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("tb/order/order_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("tb/order/order_edit");
