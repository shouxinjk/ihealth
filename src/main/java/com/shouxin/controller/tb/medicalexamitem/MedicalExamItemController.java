package com.shouxin.controller.tb.medicalexamitem;
...
public class MedicalExamItemController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("tb/medicalexamitem/medicalexamitem_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("tb/medicalexamitem/medicalexamitem_edit");
