package com.shouxin.controller.tb.medicalorder;
...
import com.shouxin.service.tb.medicalorder.MedicalOrderManager;
...
public class MedicalOrderController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("tb/medicalorder/medicalorder_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("tb/medicalorder/medicalorder_edit");
