...
public class MedicalOrder {
	...
	private double  MEDICALTOTALAMOUNT;	// double(11,0) DEFAULT NULL COMMENT '订单总金额',
	...
	public double getMEDICALTOTALAMOUNT() {
		return MEDICALTOTALAMOUNT;
	}
	public void setMEDICALTOTALAMOUNT(double mEDICALTOTALAMOUNT) {
	...
	public String toString() {
		return "MedicalOrder [MEDICALORDER_ID=" + MEDICALORDER_ID + ", MEDICALORDERNO=" + MEDICALORDERNO
				...
				+ ", MEDICALTOTALAMOUNT=" + MEDICALTOTALAMOUNT + ", STATUS=" + STATUS + ", CREATEBY="
