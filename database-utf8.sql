...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理组', '40347683204003790837655673279253784656431437762429340716594894969471682909012346399980242429171080366881201244935806918', '0', '1', '1', '1', '1');
...
INSERT INTO `sys_role` VALUES ('3', '企业管理员', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531880211727219469415202623759351191654711808021002969030', '1', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531880211727219469415202623759351191654711808021002969030', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531880211727219469415202623759351191654711808021002969030', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531880211727219469415202623759351191654711808021002969030', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531880211727219469415202623759351191654711808021002969030');
INSERT INTO `sys_role` VALUES ('3264c8e83d0248bb9e3ea6195b4c0216', '一级管理员', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531688649784611233307907830380957403006759465630730018758', '1', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531688649784611233307907830380957403006759465630730018758', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531688649784611233307907830380957403006759465630730018758', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531688649784611233307907830380957403006759465630730018758', '17444132155764259615041622861945977231974243497280614552162797136237980111806590531688649784611233307907830380957403006759465630730018758');
...
INSERT INTO `sys_role` VALUES ('68f8e4a39efe47c7bb869e9d15ab925d', '二级管理员', '40347683204003790837655673279253784656431437762429340716594894969471682909012346399980242429171080366881201244935806918', '1', '0', '0', '2251798773489606', '0');
...
INSERT INTO `sys_role` VALUES ('de9de2f006e145a29d52dfadda295353', '三级管理员', '40347683204003790837655673279253784656431437762429340716594894969471682909012346399980242429171080366881201244935806918', '1', '0', '0', '0', '0');
INSERT INTO `sys_role` VALUES ('e32c2f37d1744d10a76813eee4a882ae', '医生', '2251798773489606', '1', '118571198322457521683259327569727595184370969558060170687607043650807803989196992', '118571198322457521683259327569727595184370969558060170687607043650807803989196992', '118571198322457521683259327569727595184370969558060170687607043650807803989196992', '118571198322457521683259327569727595184370969558060170687607043650807803989196992');
...
CREATE TABLE `admin_disease` (
  ...
  `ISALABLE` int(11) DEFAULT '1' COMMENT '是否显示标签',
  `CREATEBY` varchar(255) DEFAULT NULL COMMENT '创建记录员工id',
  `CREATEON` timestamp NULL DEFAULT NULL COMMENT '创建记录时间',
...
CREATE TABLE `tb_medicalexamitem` (
  ...
  `STATUS` set('审核','提交','失效','发布','审核失败','新建') DEFAULT '新建' COMMENT '体检项目状态',
...
CREATE TABLE `tb_medicalorder` (
  ...
  `MEDICALTOTALAMOUNT` double DEFAULT NULL COMMENT '订单总金额',
  `STATUS` set('已提交','已确认','已付款','订单完成','用户执行','再次确认','已预约','体检中心确认','等待付款') DEFAULT '已提交' COMMENT '订单状态',
  `CREATEBY` varchar(255) DEFAULT NULL COMMENT '创建该记录用户id',
  `CREATEON` timestamp NULL DEFAULT NULL COMMENT '创建该记录时间',
  `MEDICALCENTER_ID` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tb_order` (
  ...
  `STATUS` set('订单完成','已执行','体检再次确认','平台确认','已预约','已付款','等待付款','已提交','体检中心确认','新建') DEFAULT '新建' COMMENT '订单状态',
  `CREATEBY` varchar(255) DEFAULT NULL COMMENT '创建该记录用户',
  `CREATEON` timestamp NULL DEFAULT NULL COMMENT '创建该记录时间',
  `APP_USERID` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tb_enterprise` (
  ...
  `STATUS` set('新建','审核通过','已提交','审核失败') DEFAULT '新建',
